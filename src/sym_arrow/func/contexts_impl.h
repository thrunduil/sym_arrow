...
class function_evaler_impl
{
    ...
    private:
        using key_type  = std::pair<symbol, size_t>;
    ...
    private:
        ...
        bool            eval_function_value(const symbol& name, const expr* subexpr, 
                            size_t n_size, expr& res) const;
        bool            eval_function_expr(const symbol& name, const expr* subexpr, 
                            size_t n_size, expr& res) const;

        void            error_evaler_defined(const symbol& name, size_t n_size);
        void            error_partial_evaler_defined(const symbol& name, size_t n_size);
};
